...
async function handleAzureAIAgent(userMessage, conversationHistory = [], guestProfile = null) {
...
${profileContext}${onboardingPrompt}
  ...
  try {
    ...
    if (USE_AZURE_AI && azureOpenAIClient) {
      try {
        ...
        result = await handleAzureAIAgent(message, conversationHistory, guestProfile);
      } catch (error) {
